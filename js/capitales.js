...
let preguntaActual = preguntas[getRandomNumber(31)];

let preguntaTextoH2 = document.getElementById('preguntaCapital');

preguntaTextoH2.innerHTML =  `¿Cuál es la capital de ${preguntaActual.nombrePais}?`;
...
let main = document.getElementById('mainCapitales');
...
function generarNuevaPregunta() {
    preguntaActual = preguntas[getRandomNumber(31)];
    preguntaTextoH2.innerHTML = `¿Cuál es la capital de ${preguntaActual.nombrePais}?`;
